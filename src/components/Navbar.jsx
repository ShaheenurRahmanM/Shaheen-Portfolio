...
//     >
//       <Logo>
//         <Link to="/" style={{ color: "#00c4ff", textDecoration: "none" }}>Shaheen</Link>
//       </Logo>
//       <NavLinks id="desktopLinks">
//         <LinkWrapper to="/"><FaHome />Home</LinkWrapper>
//         <LinkWrapper to="/about"><FaUser /> About</LinkWrapper>
//         <LinkWrapper to="/skills"><FaCogs /> Expertize</LinkWrapper>
//         <LinkWrapper to="/projects"><FaBriefcase /> Projects</LinkWrapper>
//         <LinkWrapper to="/contact"><FaEnvelope /> Contact</LinkWrapper>
//       </NavLinks>
